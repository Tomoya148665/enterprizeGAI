...
const AIComment: FunctionComponent = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-start pt-2.5 pb-0 pr-8 pl-4 md:pr-16 md:pl-12  ld:pr-[25%] ld:pl-[20%] gap-[10px] text-left text-xs text-black font-inter">
      <img
